...
# Volunteers
Volunteer.create(photo_url: "https://avatars2.githubusercontent.com/u/13993?v=3&s=400", first_name: "Derek", last_name: "Reeve", email: "derek@gmail.com", password: "123", interest: "Cats")
...
Event.create(name: "Coach a team for Girls on the Run", category_id: 3, organization_id:7, volunteer_id: 1, org_name: "Girls on the Run", location: "3543 18th Street San Francisco, CA 94110", date: "Saturday, September 5, 2015 - Sunday, December 20, 2015", time: "TBD", image: "https://grassroots.groupon.com/files/2012/09/girls-on-the-run-logo.jpeg")
