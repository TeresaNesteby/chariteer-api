...
Event.create(name: "Coastal Cleanup Day", category_id: 2, organization_id:1, volunteer_id: 1, org_name: "Aquarium of the Bay", place: "San Francisco Bay", date: "Saturday, September 19, 2015", time: "9:00 AM-12:00 AM", image: "https://pbs.twimg.com/profile_images/3343036919/d8ba4f06f2a81fd1e9df377889855fe1_400x400.jpeg", num_of_volunteers_needed: 10)
Event.create(name: "Volunteer Water Quality Technician", category_id: 2, organization_id:2, volunteer_id: 1, org_name: "Golden Gate Audubon Society", place: "San Francisco Bay", date: "Saturday, September 5, 2015 and Saturday, October 3, 2015", time: "9 AM - Noon", image: "https://www.teenlife.com/media/uploads/listings//golden-gate-audubon-society/GGAS%20logo.jpg", num_of_volunteers_needed: 5)

Event.create(name: "Habitat Restoration ", category_id: 2, organization_id:1, volunteer_id: 1, org_name: "Aquarium of the Bay", place: "San Francisco Bay", date: "Saturday, September 19, 2015", time: "9:00 AM-12:00 AM", image: "http://cdn.funcheap.com/wp-content/uploads/2013/02/megashark_31.jpg", num_of_volunteers_needed: 25)

Event.create(name: "Support our nation's military and their families", category_id: 1, organization_id:3, volunteer_id: 1, org_name: "American Red Cross", place: "1300 Alberta Way", date: "It's flexible!", time: "We'll work with your schedule!", image: "https://www.missionmanager.com/wp-content/uploads/2015/07/American-Red-Cross.jpg", num_of_volunteers_needed: 20)

Event.create(name: "Online Organizing Intern", category_id: 5, organization_id:8, volunteer_id: 1, org_name: "Tenants Together", place: "995 Market Street, Suite 1202, San Francisco, CA 94103", date: "It's flexible!", time: "We'll work with your schedule!", image: "http://www.beyondchron.org/wp-content/uploads/news_images/2012/tenants_together.jpg", num_of_volunteers_needed: 10)


Event.create(name: "Coach a team for Girls on the Run", category_id: 3, organization_id:7, volunteer_id: 1, org_name: "Girls on the Run", place: "3543 18th Street San Francisco, CA 94110", date: "Saturday, September 5, 2015 - Sunday, December 20, 2015", time: "TBD", image: "https://grassroots.groupon.com/files/2012/09/girls-on-the-run-logo.jpeg", num_of_volunteers_needed: 5)
